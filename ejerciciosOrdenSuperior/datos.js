const beers = [
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Pale Ale", amount: { value: 3.13, unit: "kilograms" } },
                { name: "Caramalt", amount: { value: 0.25, unit: "kilograms" } },
                { name: "Crystal 150", amount: { value: 0.18, unit: "kilograms" } },
                {
    ...
    },
    {
        ...
        boil_volume: { value: 25, unit: "litres" },
        method: {
            mash_temp: [{ temp: { value: 68, unit: "celsius" }, duration: 50 }],
            fermentation: { temp: { value: 19, unit: "celsius" } },
            twist: null,
        },
        ingredients: {
            malt: [
                {
                    name: "Maris Otter Extra Pale",
                    amount: { value: 3.44, unit: "kilograms" },
                },
            ...
            hops: [
                {
                    name: "Cascade",
                    amount: { value: 43.8, unit: "grams" },
                    add: "start",
                    attribute: "bitter",
                },
                {
                    name: "Cascade",
                    amount: { value: 81.3, unit: "grams" },
                    add: "end",
                    attribute: "flavour",
                },
                {
            ...
            malt: [
                {
                    ...
                    amount: { value: 11.1, unit: "kilograms" },
                },
                { name: "Caramalt", amount: { value: 0.94, unit: "kilograms" } },
                { name: "Crystal", amount: { value: 0.44, unit: "kilograms" } },
            ],
            hops: [
                {
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Pale Ale", amount: { value: 6.13, unit: "kilograms" } },
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Extra Pale", amount: { value: 6.12, unit: "kilograms" } },
                { name: "Caramalt", amount: { value: 0.8, unit: "kilograms" } },
            ],
            hops: [
                {
                    name: "Tomahawk",
    ...
    },
    {
        ...
        boil_volume: { value: 25, unit: "litres" },
        method: {
            mash_temp: [{ temp: { value: 64, unit: "celsius" }, duration: 60 }],
            fermentation: { temp: { value: 21, unit: "celsius" } },
            twist: null,
        },
        ingredients: {
            malt: [
                { name: "Extra Pale", amount: { value: 5.63, unit: "kilograms" } },
                { name: "Wheat", amount: { value: 0.69, unit: "kilograms" } },
                { name: "Crystal", amount: { value: 0.63, unit: "kilograms" } },
            ],
            hops: [
                {
    ...
    },
    {
        ...
        ingredients: {
            malt: [
                { name: "Extra Pale", amount: { value: 2.69, unit: "kilograms" } },
